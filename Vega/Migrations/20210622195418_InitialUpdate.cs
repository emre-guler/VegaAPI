        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Content = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Photo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    YesRate = table.Column<float>(type: "real", nullable: false),
                    NoRate = table.Column<float>(type: "real", nullable: false),
                    AnswerState = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TicketQuestions_Questions_QuestionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketQuestions_QuestionId",
                table: "TicketQuestions",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_TicketQuestions_TicketId",
                table: "TicketQuestions",
                column: "TicketId");
